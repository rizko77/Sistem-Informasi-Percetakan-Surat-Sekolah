...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Daftar Kegiatan Guru</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Daftar Kegiatan Guru</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <div class="card">
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <?php foreach ($kegiatan_guru as $index => $kg) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="/admin/hapusKegiatanGuru/<?= $kg['id'] ?>" method="post" style="display: inline-block;">
                                            <input type="hidden" name="_method" value="DELETE">
                                            <button type="submit" class="btn btn-sm btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus kegiatan ini?')">Hapus</button>
                                        </form> 
                                    </td>
...
<div class="modal fade" id="modalTambahKegiatan" tabindex="-1" role="dialog" aria-labelledby="modalTambahKegiatanLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formTambahKegiatan" action="/admin/simpanKegiatanGuru" method="POST">
...
<!-- Modal Edit Kegiatan -->
<?php foreach ($kegiatan_guru as $kg) : ?>
    <div class="modal fade" id="modalEditKegiatan<?= $kg['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="modalEditKegiatanLabel<?= $kg['id'] ?>" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form id="formEditKegiatan<?= $kg['id'] ?>" action="/admin/updateKegiatanGuru" method="POST">
                    <div class="modal-body">
...
<script>
    ...
    // Fungsi untuk menghapus kegiatan guru
    function deleteKegiatanGuru(id) {
        if (confirm('Apakah Anda yakin ingin menghapus kegiatan ini?')) {
            $.ajax({
                url: '/admin/hapusKegiatanGuru/' + id, // Sesuaikan dengan rute yang benar
                type: 'DELETE',
