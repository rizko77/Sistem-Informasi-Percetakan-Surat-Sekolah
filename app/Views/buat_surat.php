...
<body>
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><b>Buat Surat Pernyataan Siswa</b></div>
                    <div class="card-body">
                        <form id="buatSuratForm" method="post">
                            ...
                            <a href="/siswa" class="btn btn-danger btn-lg rounded-pill ml-2">Kembali</a>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <script>
        function submitForm() {
            ...
            // Open a new window
            const win = window.open('/cetakPDF', '_blank');
